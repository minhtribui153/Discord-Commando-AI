...
const reasons = require('@system/moderation/mute/reasons.json')
...
module.exports = class MuteCommand extends Commando.Command {
  ...
  run = async (message, args) => {
    ...
    if (!mutedRole) {
      message.reply('Could not find a "Temporarily Muted" role')
      return
    }
    ...
    message.reply(
      `You muted <@${target.id}> for "${reason}". They will be unmuted in ${duration} minutes.`
    )
  }
}